          ...
          <form method="post" action="function.php">
            <div class="row jumbotron box8">
              <div class="col-sm-12 mx-t3 mb-4">
                <h2 class="text-center text-info" style="color:green">
                  <?php if(isset($_REQUEST['ok'])){echo '<b style="color:green">Kayıt Başarılı</b>';
                  }
                  else
                    {
                      echo '<p>Register</p>';
              ...
              <div class="col-sm-6 form-group">
                ...
                <select class="form-control browser-default custom-select" name="sex">
              ...
              <div class="col-sm-12 form-group mb-0">
                <input class="btn btn-primary float-right" value="Register" type="submit" name="btnRegister">
              </div>
